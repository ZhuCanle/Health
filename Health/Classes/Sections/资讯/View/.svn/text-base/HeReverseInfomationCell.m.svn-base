...
@interface HeReverseInfomationCell ()<TTGTagCollectionViewDelegate, TTGTagCollectionViewDataSource>
...
@implementation HeReverseInfomationCell
...
- (UILabel *)bulidLabelWithTitle:(NSString *)title withTag:(NSInteger)tag
{
    ...
    }else if ([title isEqualToString:@"广告"])
    {
        [label setLayoutWithCornerRadius:2.5 borderColor: UIColorFromRGB(0x999999) borderWidth:1];
        label.textColor = UIColorFromRGB(0x999999);
    }else
    {
        [label setLayoutWithCornerRadius:2.5 borderColor: UIColorFromRGB(0xff9933) borderWidth:1];
        label.textColor = UIColorFromRGB(0xff9933);
    }
    return label;
}
